  ...
  <div class="item">
    <div class="item-header row" v-on:click="toggleItem()">
      ...
      <div class="col-xs-3 item-sub">
        <div class="box">
          <h4 class="company">{{position.company.name}}</h4>
          <p class="location">{{position.company.location}}</p>
        </div>
      </div>
      ...
      <div class="col-xs-1 item-action">
        <div class="box">
          <button class="item-button item-button-expand">
            +
          </button>
          <button class="item-button item-button-narrow">
            -
          </button>
        </div>
      </div>
